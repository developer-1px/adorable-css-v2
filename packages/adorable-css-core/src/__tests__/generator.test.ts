...
describe("generateCSSFromAdorableCSS", () => {
  ...
  describe("Error handling", () => {
    ...
    it("should handle parser errors", () => {
      ...
      const result = generateCSSFromAdorableCSS("invalid-syntax");
      expect(result).toBe(""); // Should fail gracefully
    });
    ...
    it("should escape special characters in CSS selectors", () => {
      ...
      testCases.forEach(({ input, expected }) => {
        mockParseAdorableCSS.mockReturnValue({
          ...
          value: [
            {
              selector: { image: "block" }, // Use a valid rule handler
              combinators: [],
            },
          ],
        } as any);
  ...
  describe("Advanced features", () => {
    it("should handle complex CSS generation", () => {
      ...
      mockParseAdorableCSS.mockReturnValue({
        ...
        value: [
          {
            selector: { image: "block" }, // Use valid rule handler
            combinators: [],
          },
        ],
      } as any);
