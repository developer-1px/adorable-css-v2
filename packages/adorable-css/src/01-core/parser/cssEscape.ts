...
export const cssEscape = (string:string):string => {
  ...
  while (++index < length) {
    ...
    // If the character is not handled by one of the above 03-rules and is
...
/**
 * Clean up CSS selectors by removing duplicate class names
 * Example: .elevation\(6\).elevation\(6\) -> .elevation\(6\)
 */
