...
export const defaultSemanticSystem: SemanticDesignSystem = {
  colors: {
    brand: {
      primary: 'indigo-600',    // Unified with 02-design_tokens/index.ts
      secondary: 'slate-600',   // Unified with 02-design_tokens/index.ts
      accent: 'violet-500',     // Unified with 02-design_tokens/index.ts
    },
    ui: {
      background: 'white',
      surface: 'gray-50',
    ...
    state: {
      success: 'emerald-600',    // Unified with 02-design_tokens/index.ts
      successLight: 'emerald-50',
      warning: 'amber-500',       // Unified with 02-design_tokens/index.ts
      warningLight: 'amber-50',
      error: 'red-600',           // Unified with 02-design_tokens/index.ts
      errorLight: 'red-50',
      info: 'sky-500',            // Unified with 02-design_tokens/index.ts
      infoLight: 'sky-50',
    },
    interactive: {
      hover: 'gray-50',
