...
describe('tokenRegistry', () => {
  ...
  describe('registerToken', () => {
    it('should register spacing 02-design_tokens', () => {
    ...
    it('should register font 02-design_tokens', () => {
    ...
    it('should not register duplicate 02-design_tokens', () => {
      registerToken('spacing', 'xl')
      registerToken('spacing', 'xl')
  ...
  describe('generateUsedTokensCSS', () => {
    it('should generate CSS for used spacing 02-design_tokens', () => {
    ...
    it('should generate CSS for used font 02-design_tokens', () => {
    ...
    it('should generate empty CSS when no 02-design_tokens are used', () => {
      const css = generateUsedTokensCSS()
