...
const proseDefinition: ComponentDefinition = {
  ...
  selectors: {
    ...
    'h1': 'heading(h1) c(neutral-900) mt(0) mb(2xl)',
    'h2': 'heading(h2) c(neutral-900) mt(5xl) mb(lg) pb(sm) border-b(1/neutral-200)',
    'h3': 'heading(h3) c(neutral-900) mt(3xl) mb(md)',
    'h4': 'heading(h4) c(neutral-900) mt(2xl) mb(sm)',
    'h5': 'heading(h5) c(neutral-900) mt(lg) mb(sm)',
