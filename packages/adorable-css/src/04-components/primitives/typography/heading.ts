...
export const headingDefinition: ComponentDefinition = {
  ...
  sizes: {
    ...
    h3: 'text(xl/snug) bold(semi)',
    h4: 'text(lg/relaxed) bold(semi)',
    h5: 'text(md/relaxed) bold(semi)',
    h6: 'text(sm/relaxed/widest) bold(semi) uppercase',

    default: 'text(3xl/1.3/-1.5%) bold(semi)' // Default to h1-like style
  },
  ...
  compounds: [
    ...
    // Serif variants get adjusted letter spacing
    {
      ...
      class: 'font(serif) leading(1.2) tracking(-2%)'
    },
