import type { StringRuleHandler, CSSRule, RuleHandler, KeywordRuleHandler } from '../03-rules/types';
        ...
        if (priorityRegistry.hasString(selectorName)) {
          ...
          if (stringRule) {
            ...
            if (typeof result === 'string') {
              ...
              // Handle array results [string, CSSRule] from 04-components
              ...
              // Note: We ignore the nested 03-rules here as they're for selectors,
