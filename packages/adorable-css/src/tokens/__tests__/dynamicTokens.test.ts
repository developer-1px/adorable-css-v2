...
describe('dynamicTokens', () => {
  ...
  describe('generateSpacingCalc', () => {
    it('should return CSS variable for spacing tokens', () => {
    ...
    it('should handle large spacing tokens', () => {
    ...
    it('should register tokens when generating', () => {
  ...
  describe('generateFontCalc', () => {
    it('should return CSS variable for font tokens', () => {
    ...
    it('should handle large font tokens', () => {
  ...
  describe('generateSizeCalc', () => {
    it('should return CSS variable for size tokens', () => {
    ...
    it('should handle numeric size tokens', () => {
