...
describe('Importance (!) feature', () => {
  test.skip('should parse ! marks in selectors and store them', () => { // Clarified test name
  ...
  test.skip('should add [class] for each ! mark to increase specificity in generated CSS', () => { // Clarified test name
  ...
  test.skip('should work with function selectors and add specificity', () => { // Clarified test name
    const css = generateClass('p(16)!');
    expect(css).toContain('[class].p\(16\)\!{');
    expect(css).toContain('padding:16px');
  });

  test.skip('should work with multiple ! marks and functions and add specificity', () => { // Clarified test name
    const css = generateClass('bg(red)!!');
    expect(css).toContain('[class][class].bg\(red\)\!\!{');
    expect(css).toContain('background-color:red');
  });

  test.skip('should work with pseudo-classes and add specificity', () => { // Clarified test name
  ...
  test.skip('should work with responsive classes and add specificity', () => { // Clarified test name
  ...
  test.skip('should return empty string for invalid function arguments with !', () => { // Added new test case
