...
<div class="min-h(screen) bg(neutral-50)">
  <!-- Navigation -->
  <nav class="bg(white/auto-text) bb(1/neutral-100) sticky top(0) z(50) backdrop-blur">
      ...
      <div class="hbox(between/middle)">
        ...
        <div class="hbox gap(lg) items(center)">
          ...
          <button class="relative p(xs) hover:bg(neutral-50) r(md) transition">
            ...
            <span class="absolute top(-6) right(-6) size(14) bg(neutral-900/auto-text) r(full) font(2xs) hbox(center/middle)">3</span>
          </button>
  ...
  <div class="container(7xl) mx(auto) px(2xl) pt(lg)">
    <div class="hbox gap(xs) items(center) font(2xs) c(neutral-500)">
  ...
  <div class="container(7xl) mx(auto) px(2xl) py(xl)">
    <div class="grid(2) gap(4xl) items(start) ..lg:grid(1)">
      ...
      <div class="vbox gap(lg)">
        ...
        <div class="vbox gap(sm)">
          <div class="font(2xs) c(neutral-500)">{product.brand}</div>
          ...
          <div class="hbox gap(md) items(center)">
            ...
            <span class="font(2xs) c(neutral-500)">({product.reviews.toLocaleString()} reviews)</span>
          </div>
        </div>
        ...
        <div class="vbox gap(xs)">
          ...
          {#if product.originalPrice > product.storage[selectedStorage].price}
            <span class="font(2xs) c(green-600)">
        ...
        <div class="vbox gap(sm)">
          ...
          <p class="font(2xs) c(neutral-500)">{product.colors[selectedColor].name}</p>
        </div>
        ...
        <div class="vbox gap(md) pt(md)">
          <div class="hbox gap(xl) items(center)">
            <div class="vbox gap(xs)">
              <label class="font(2xs) c(neutral-500)">Quantity</label>
            ...
            <div class="font(2xs) c(green-600)">
        ...
        <div class="vbox gap(xs) pt(sm)">
          {#each product.features.slice(0, 3) as feature}
            <div class="hbox gap(sm) items(center)">
              ...
              <span class="font(2xs) c(neutral-600)">{feature}</span>
            </div>
          {/each}
        </div>
        ...
        <div class="hbox gap(lg) pt(md) border-t(1/neutral-100)">
          <div class="vbox gap(0)">
            <span class="font(2xs) c(neutral-700)">Free Shipping</span>
            <span class="text(3xs) c(neutral-500)">Orders $50+</span>
          </div>
          <div class="vbox gap(0)">
            <span class="font(2xs) c(neutral-700)">2 Year Warranty</span>
            <span class="text(3xs) c(neutral-500)">Full coverage</span>
          </div>
          <div class="vbox gap(0)">
            <span class="font(2xs) c(neutral-700)">Easy Returns</span>
    ...
    <div class="vbox gap(lg) pt(3xl)">
      <!-- Tab Navigation -->
      <div class="hbox gap(xl) bb(1/neutral-100)">
        {#each ['description', 'specifications', 'reviews'] as tab}
          <button 
            class="pb(sm) bb(2/{activeTab === tab ? 'neutral-900' : 'transparent'}) caption {activeTab === tab ? 'c(neutral-900)' : 'c(neutral-500)'} hover:c(neutral-700) transition"
              ...
              <div class="vbox gap(xs) pt(md)">
                ...
                <div class="vbox gap(xs)">
                  {#each ['AirPods Pro Max Studio', 'Lightning to USB-C Cable', 'Smart Case', 'Documentation'] as item}
                    <div class="hbox gap(sm)">
                      <span class="font(2xs) c(neutral-500)">•</span>
                      <span class="font(2xs) c(neutral-600)">{item}</span>
                    </div>
                  {/each}
                </div>
              </div>
        ...
        {:else if activeTab === 'specifications'}
          <div class="max-w(2xl) vbox gap(0)">
            {#each Object.entries(product.specs) as [key, value]}
              <div class="hbox(between) py(sm) bb(1/neutral-100)">
          ...
          <div class="vbox gap(xl)">
            ...
            <div class="hbox gap(xl) items(center)">
              ...
              <div class="vbox gap(xs) flex-1 max-w(sm)">
                {#each [5,4,3,2,1] as stars}
                  <div class="hbox gap(sm) items(center)">
                    <span class="font(2xs) c(neutral-500) w(8)">{stars}</span>
                    ...
                    <span class="font(2xs) c(neutral-500) w(24)">{stars === 5 ? '70%' : stars === 4 ? '20%' : '5%'}</span>
                  </div>
                {/each}
              </div>
            </div>
            ...
            <div class="vbox gap(md)">
              {#each [
                ...
                <div class="vbox gap(sm) py(md) bb(1/neutral-100)">
                  <div class="hbox(between) items(start)">
                    <div class="hbox gap(sm) items(center)">
                      ...
                      <span class="font(2xs) c(neutral-500)">{review.date}</span>
                    </div>
                  </div>
          ...
          <div class="bg(white/auto-text) r(md) group">
            ...
            <div class="p(md) vbox gap(xs)">
              ...
              <div class="hbox gap(xs) items(center)">
                ...
                <span class="font(2xs) c(neutral-500)">({item.rating})</span>
              </div>
              <div class="hbox(between) items(center) pt(xs)">
                <span class="body(sm) c(neutral-900)">{formatPrice(item.price)}</span>
                <button class="px(sm) py(2xs) border(1/neutral-900) r(sm) font(2xs) c(neutral-900) hover:bg(neutral-50) transition">
                  Add
                </button>
              </div>
            </div>
  ...
  <footer class="bg(neutral-900/auto-text) pt(3xl) pb(xl) mt(3xl)">
    <div class="container(7xl) mx(auto) px(2xl)">
      <div class="grid(4) gap(3xl) ..lg:grid(2) ..sm:grid(1) pb(2xl) bb(1/neutral-800)">
        <div class="vbox gap(sm)">
          <h3 class="body(md)">techstore</h3>
          <p class="font(2xs) c(neutral-500) leading(relaxed)">
        ...
        <div class="vbox gap(sm)">
          ...
          <div class="vbox gap(xs)">
            <a href="#" class="font(2xs) c(neutral-500) hover:c(white) transition">All Products</a>
            <a href="#" class="font(2xs) c(neutral-500) hover:c(white) transition">New Arrivals</a>
            <a href="#" class="font(2xs) c(neutral-500) hover:c(white) transition">Best Sellers</a>
            <a href="#" class="font(2xs) c(neutral-500) hover:c(white) transition">Sale</a>
          </div>
        </div>
        <div class="vbox gap(sm)">
          <h4 class="caption">Support</h4>
          <div class="vbox gap(xs)">
            <a href="#" class="font(2xs) c(neutral-500) hover:c(white) transition">Contact Us</a>
            <a href="#" class="font(2xs) c(neutral-500) hover:c(white) transition">FAQs</a>
            <a href="#" class="font(2xs) c(neutral-500) hover:c(white) transition">Shipping</a>
            <a href="#" class="font(2xs) c(neutral-500) hover:c(white) transition">Returns</a>
          </div>
        </div>
        <div class="vbox gap(sm)">
          <h4 class="caption">Stay Updated</h4>
          <p class="font(2xs) c(neutral-500)">Get special offers and new product updates</p>
          <div class="hbox gap(xs)">
            <input 
              type="email" 
              placeholder="Email"
              class="flex-1 px(sm) py(xs) bg(transparent) border(1/neutral-700) r(sm) font(2xs) c(white) placeholder:c(neutral-600)"
            />
            <button class="px(md) py(xs) bg(white) c(neutral-900) r(sm) font(2xs) hover:bg(neutral-200) transition">
              Join
            </button>
          </div>
        </div>
      ...
      <div class="pt(lg) hbox(between) items(center) ..sm:vbox ..sm:gap(sm)">
        <p class="font(2xs) c(neutral-500)">© 2024 TechStore. All rights reserved.</p>
        <div class="hbox gap(md)">
          <a href="#" class="font(2xs) c(neutral-500) hover:c(white) transition">Privacy</a>
          <a href="#" class="font(2xs) c(neutral-500) hover:c(white) transition">Terms</a>
        </div>
      </div>
    </div>
  </footer>
