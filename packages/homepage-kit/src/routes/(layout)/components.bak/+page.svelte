          ...
          <div class="vbox gap(2xl) p(2xl) r(xl) bg(to-br/purple-50..blue-50) border(1/purple-200)">
            ...
            <div class="grid(2) gap(xl)">
              <div class="vbox gap(sm)">
                <h3 class="font(lg/semibold) c(gray-900)">포함된 컴포넌트</h3>
                <ul class="vbox gap(xs) pl(xl)">
                  <li class="c(gray-700)">• Buttons, Badges, Cards, Avatars</li>
                  <li class="c(gray-700)">• Form elements (Input, Select, Checkbox, etc.)</li>
                  <li class="c(gray-700)">• Tables, Progress bars, Skeletons</li>
                  <li class="c(gray-700)">• Navigation (Tabs, Breadcrumbs, Pagination)</li>
                  <li class="c(gray-700)">• Overlays (Dialog, Toast, Tooltips)</li>
                  <li class="c(gray-700)">• And many more...</li>
                </ul>
              </div>
              
              <div class="vbox gap(sm)">
                <h3 class="font(lg/semibold) c(gray-900)">특징</h3>
                <ul class="vbox gap(xs) pl(xl)">
                  <li class="c(gray-700)">• 순수 AdorableCSS로 구현</li>
                  <li class="c(gray-700)">• 다양한 variant 지원</li>
                  <li class="c(gray-700)">• 반응형 디자인</li>
                  <li class="c(gray-700)">• 접근성 고려</li>
                  <li class="c(gray-700)">• 쉬운 커스터마이징</li>
                </ul>
              </div>
            </div>
            
            <div class="hbox gap(md)">
              <a href="/components/showcase" class="btn(primary/lg) inline-flex hbox(middle) gap(sm)">
                <span>컴포넌트 쇼케이스 보기</span>
                <svg class="size(20)" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  <path d="M5 12h14m-7-7l7 7-7 7"/>
                </svg>
              </a>
              <a href="/design-system/components" class="btn(outline/lg)">
                기존 컴포넌트 문서
              </a>
            </div>
          </div>
