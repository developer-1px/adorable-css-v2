...
<div class="hbox gap(xl) selected">
...
<div class="hbox gap(xl) selected >div:c(blue) >div.selected:c(red)">
  <div>link #1</div>
...
<div class="hbox gap(xl) selected >>a:c(blue)">
