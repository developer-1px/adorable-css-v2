...
<div class="w(6xl) h(6xl) bg(orange) p(10px) m(10px)">64 x 64</div>

<div class="w(50%) w(~320) b(orange) bg(#fff) p(10px)">w(50%) w(~320) = width:100%; max-width: 320px</div>

<div class="w(128px) h(128px) r(20) bg(red) p(xl)">128 x 128 r(20)</div>

<div class="bl(4/red) bg(#f00.2) p(xl) m(10px)">quoto</div>

<div class="bg(blue) c(#fff) rl(20) p(xl)">border-radius left</div>

<div class="bg(#fff) w(100px) h(100px) bt(red) br(8/orange) bb(dashed) bl(dotted/blue) m(xl)">bt br bb bl</div>
