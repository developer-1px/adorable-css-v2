...
<div class="docs-page hbox w(fill) min-h(screen) bg(white)">
  <!-- Sidebar -->
  <aside class="sidebar w(280px) h(screen) bg(gray-50) b(r/gray-200) sticky top(0) clip-y">
    <div class="p(xl)">
      <h2 class="font(lg) bold c(gray-900) mb(xl)">Documentation</h2>
      
      <nav class="vbox gap(sm)">
        {#each sections as section}
          <div class="nav-section">
            <button 
              class="nav-header w(full) hbox(middle) gap(sm) px(md) py(sm) r(lg) text(left) hover:bg(gray-100) transition {activeSection === section.id ? 'bg(primary-50) c(primary)' : ''}"
            ...
            {#if activeSection === section.id}
              <div class="nav-items vbox gap(xs) pl(xl) mt(xs)">
                {#each section.items as item}
                  <a 
                    href="#{item.id}" 
                    class="nav-item px(md) py(xs) r(md) font(sm) c(gray-600) hover:c(primary) hover:bg(gray-100) transition"
                  >
                    {item.title}
                  </a>
                {/each}
    ...
    {#if activeSection === 'getting-started'}
      <article class="vbox gap(3xl)">
        <section id="installation">
          ...
          <div class="mb(xl)">
            <h3 class="font(lg) bold c(gray-900) mb(md)">Package Installation</h3>
          ...
          <div class="mb(xl)">
            <h3 class="font(lg) bold c(gray-900) mb(md)">Vite Configuration</h3>
            <div class="p(lg) bg(gray-50) r(lg)">
        ...
        <section id="philosophy">
          ...
          <div class="vbox gap(xl)">
            <div class="principle p(xl) bg(primary-50) r(lg) b(l/4/primary)">
              <h3 class="font(lg) bold c(gray-900) mb(sm)">1. Figma-First Design</h3>
              <p class="font(md) c(gray-600)">
            ...
            <div class="principle p(xl) bg(success-50) r(lg) b(l/4/success)">
              <h3 class="font(lg) bold c(gray-900) mb(sm)">2. Declarative Syntax</h3>
              <p class="font(md) c(gray-600)">
                Write what you mean. <code class="code-inline">vbox gap(16)</code> is clearer than memorizing flexbox properties.
              </p>
            </div>
            
            <div class="principle p(xl) bg(warning-50) r(lg) b(l/4/warning)">
              <h3 class="font(lg) bold c(gray-900) mb(sm)">3. Zero Runtime</h3>
              <p class="font(md) c(gray-600)">
      ...
      <article class="vbox gap(3xl)">
        <section id="syntax">
          ...
          <div class="syntax-examples vbox gap(xl)">
            <div>
              <h3 class="font(lg) bold c(gray-900) mb(md)">Basic Syntax</h3>
...
property!          // hidden!`} />
            ...
            <div>
              <h3 class="font(lg) bold c(gray-900) mb(md)">Prefixes</h3>
...
hover:md:property(value)  // hover:md:scale(1.1)`} />
            ...
            <div>
              <h3 class="font(lg) bold c(gray-900) mb(md)">Complex Expressions</h3>
