...
<div class="typography-tokens">
  ...
  <div class="section-card bg(white.9) backdrop-blur(md) r(2xl) shadow(xl) p(xl) b(1/gray-100) mb(2xl)">
    <h3 class="700 font(xl) c(gray-900) mb(lg)">Font Sizes</h3>
      ...
      {#each Object.entries(defaultTokens.font).slice(0,6) as [key, value]}
        <div class="token-row p(md) bg(to-right/rgb(249,250,251)..transparent) hover:bg(to-right/rgb(239,246,255)..transparent) r(xl) transition group">
          <div class="hbox(middle) gap(md)">
            ...
            <div class="token-preview flex(middle) group-hover:scale(1.02) transition">
  ...
  <!-- Line Heights -->
  <div class="section-card bg(white.9) backdrop-blur(md) r(2xl) shadow(xl) p(xl) b(1/gray-100) mb(2xl)">
    <h3 class="700 font(xl) c(gray-900) mb(lg)">Line Heights</h3>
  ...
  <!-- Letter Spacing -->
  <div class="section-card bg(white.9) backdrop-blur(md) r(2xl) shadow(xl) p(xl) b(1/gray-100) mb(2xl)">
    <h3 class="700 font(xl) c(gray-900) mb(lg)">Letter Spacing</h3>
  ...
  <div class="section-card bg(white.9) backdrop-blur(md) r(2xl) shadow(xl) p(xl) b(1/gray-100)">
    <h3 class="700 font(xl) c(gray-900) mb(lg)">Font Weights</h3>
