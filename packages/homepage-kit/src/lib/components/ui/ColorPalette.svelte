<script>
  ...
  const colorGroups = {
    ...
    secondary: ['green', 'emerald', 'teal'],
    warm: ['red', 'orange', 'amber', 'yellow'],
    cool: ['cyan', 'sky', 'blue'],
    accent: ['violet', 'fuchsia', 'pink', 'rose'],
  ...
  <Card>
    ...
    <CardContent className="vbox gap(md)">
      ...
      <div class="font(sm) c(gray-600)">
        Current theme: <span class="font(medium)">{currentTheme.name}</span>
        {#if currentTheme.options}
          <span class="ml(sm) font(mono) font(xs) c(gray-500)">
            ...
            {#if colorPalette[colorName]}
              <div class="color-row vbox gap(sm)">
                ...
                <div class="color-details vbox gap(xs) mt(sm) p(sm) bg(gray-50) r(md)">
                  <div class="font(xs) c(gray-600) font(mono)">
                    Base: {getHexValue(colorName, '500') || colorPalette[colorName]['500']}
                  </div>
                  <div class="font(xs) c(gray-500) font(mono)">
        ...
        <div class="vbox gap(sm)">
          ...
          <div class="grid(3) gap(md)">
            <div class="p(md) r(md) bg(white) border(1/gray-200)">
              ...
              <div class="font(xs) c(gray-500) font(mono) mt(xs)">Text color utility</div>
            </div>
            <div class="p(md) r(md) bg(white) border(1/gray-200)">
              <div class="c(emerald-500) font(md)">c(emerald-500)</div>
              <div class="font(xs) c(gray-500) font(mono) mt(xs)">Success color</div>
            </div>
            <div class="p(md) r(md) bg(white) border(1/gray-200)">
              <div class="c(red-500) font(md)">c(red-500)</div>
              <div class="font(xs) c(gray-500) font(mono) mt(xs)">Error color</div>
            </div>
          </div>
        </div>
        ...
        <div class="vbox gap(sm)">
          ...
          <div class="grid(3) gap(md)">
            <div class="p(md) r(md) bg(blue-100) border(1/blue-200)">
              ...
              <div class="font(xs) c(blue-600) font(mono) mt(xs)">Light background</div>
            </div>
            <div class="p(md) r(md) bg(emerald-500) border(1/emerald-600)">
              <div class="c(white) font(md)">bg(emerald-500)</div>
              <div class="font(xs) c(emerald-100) font(mono) mt(xs)">Primary background</div>
            </div>
            <div class="p(md) r(md) bg(gray-800) border(1/gray-900)">
              <div class="c(white) font(md)">bg(gray-800)</div>
              <div class="font(xs) c(gray-300) font(mono) mt(xs)">Dark background</div>
            </div>
          </div>
        </div>
