  ...
  <div class="grid(2) gap(xl)">
    ...
    <div class="vbox gap(lg)">
      ...
      <div class="vbox gap(sm) p(lg) r(lg) bg(#f9fafb)">
        ...
        <div class="hbox(middle) gap(sm)">
          <div class="48x48 bg(#3b82f6) r(none)"></div>
          <div class="48x48 bg(#3b82f6) r(sm)"></div>
          <div class="48x48 bg(#3b82f6) r(md)"></div>
          <div class="48x48 bg(#3b82f6) r(lg)"></div>
          <div class="48x48 bg(#3b82f6) r(xl)"></div>
          <div class="48x48 bg(#3b82f6) r(full)"></div>
        </div>
      </div>
      ...
      <div class="vbox gap(sm) p(lg) r(lg) bg(#f9fafb)">
        ...
        <div class="hbox(middle) gap(md)">
          <div class="64x64 bg(white) r(lg) shadow(sm) p(sm)">sm</div>
          <div class="64x64 bg(white) r(lg) shadow(md) p(sm)">md</div>
          <div class="64x64 bg(white) r(lg) shadow(lg) p(sm)">lg</div>
          <div class="64x64 bg(white) r(lg) shadow(xl) p(sm)">xl</div>
        </div>
      </div>
    </div>
  </div>
