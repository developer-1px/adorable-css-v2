...
<div class="color-tokens">
  ...
  <div class="section-card bg(white/90) backdrop-blur(md) r(2xl) shadow(xl) p(xl) b(1/gray-100) mb(2xl)">
    <h3 class="font(2xl) bold c(gray-900) mb(lg)">OKLCH Color System</h3>
    <p class="font(md) c(gray-600) mb(xl)">Perceptually uniform colors with beautiful gradients</p>
    
    <!-- Gradient Examples -->
    <div class="mb(2xl)">
      <h4 class="font(lg) bold c(gray-800) mb(lg)">Gradient Examples</h4>
      <div class="grid grid-cols(1) md:grid-cols(3) gap(lg)">
        <div class="h(24) r(xl) bg(blue-400..purple-400/135deg) hbox(center+center) c(white) font(md) bold shadow(lg)">
          blue-400..purple-400
        </div>
        <div class="h(24) r(xl) bg(pink-300..orange-400/90deg) hbox(center+center) c(white) font(md) bold shadow(lg)">
          pink-300..orange-400  
        </div>
        <div class="h(24) r(xl) bg(green-400..teal-500/45deg) hbox(center+center) c(white) font(md) bold shadow(lg)">
          green-400..teal-500
        </div>
      </div>
    </div>
  ...
  <!-- Neutral Colors -->
  <div class="section-card bg(white/90) backdrop-blur(md) r(2xl) shadow(xl) p(xl) b(1/gray-100) mb(2xl)">
    <h3 class="font(xl) bold c(gray-900) mb(lg)">Neutral Colors</h3>
      ...
      {#each colorGroups.neutral as colorName}
        {#if colorGroups.palette[colorName]}
          <div class="color-scale">
            <h4 class="font(md) bold mb(sm) capitalize c(gray-800)">{colorName}</h4>
  ...
  {#each [['Warm Colors', colorGroups.warm], ['Green Colors', colorGroups.green], ['Blue Colors', colorGroups.blue], ['Purple Colors', colorGroups.purple]] as [groupName, colors]}
    <div class="section-card bg(white/90) backdrop-blur(md) r(2xl) shadow(xl) p(xl) b(1/gray-100) mb(2xl)">
      <h3 class="font(xl) bold c(gray-900) mb(lg)">{groupName}</h3>
